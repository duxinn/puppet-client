...
public class TestServerManager extends BroadcastReceiver {

    private static final String ACTION = "com.mango.puppetsystem.test.receiver";
    ...
    private static final TestServerManager instance = new TestServerManager();

    private static Context mContext;
    private static Intent mService;
    private static ServerListener mServerListener;

    public static TestServerManager getInstance(Context context) {
        if (mService == null) {
            mContext = context;
            mService = new Intent(context, TestService.class);
        }
        return instance;
    }
    ...
    public TestServerManager register() {
